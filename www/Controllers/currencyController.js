// https://github.com/Tivotal/Currency-Converter-using-HTML-CSS-JavaScript
...
var exchangeTxt = document.querySelector(".exchange_rate");
...
function getExchangeValue() {
  ...
  let url = `https://v6.exchangerate-api.com/v6/8ec8e68ed837361843c1f91d/latest/${fromCurrency.value}`;
  fetch(url)
